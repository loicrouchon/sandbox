...
public class Problem79 {
	...
	public static String shortestPasscode(String... codes) {
	...
	private static void matchPasscode(StringBuilder passcode, String code) {
	...
	private static void optimize(StringBuilder passcode, String[] codes) {
