...
import data.graph.DijkstraAlgorithm.Node;

public abstract class AbstractDijkstraTest {

    private DijkstraAlgorithm algorithm;

    @Before
    public void setUp() {
        algorithm = createDijkstraAlgorithm();
    }

    abstract protected DijkstraAlgorithm createDijkstraAlgorithm();
